                    ...
                    <div class="col-lg-6">
                        ...
                        <form method="POST" action = "edit.htm">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" value="${list_news.get(0).id}" name = "indef" readonly>
                            </div>
                            <div class="form-group">
                                <label>Имя:</label>
                                <input class="form-control" value="${list_news.get(0).name}" name = "name" required>
                            </div>
                            <div class="form-group">
                                <label>Права</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name = "small_text" class="form-control" required>${list_news.get(0).small_text}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Полный текст</label>
                                <textarea name = "full_text"  class="form-control" required>${list_news.get(0).full_text}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Картинка</label>
                                <input class="form-control" value="${list_news.get(0).img}" name = "img" required>
                            </div>    
